                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-12 text-center ">
                            ...
                            <p class="text-white animated slideInLeft mb-4 pb-2">Get in touch with us for any questions or feedback</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="row gy-4">
                            <div class="col-md-4">
                                ...
                                <p><i class="fa fa-envelope-open text-primary me-2"></i><?php echo htmlspecialchars($settings['site_email']); ?></p>
                            </div>
                            <div class="col-md-4">
                                <h5 class="section-title ff-secondary fw-normal text-start text-primary">General</h5>
                                <p><i class="fa fa-phone-alt text-primary me-2"></i><?php echo htmlspecialchars($settings['site_phone']); ?></p>
                            </div>
                            <div class="col-md-4">
                    ...
                    <div class="col-md-6 wow fadeIn" data-wow-delay="0.1s">
                        <iframe class="position-relative rounded w-100 h-100"
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3940.3710969877!2d38.7617!3d9.0327!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zOcKwMDEnNTQuMCJOIDM4wrA0NSc0Mi4xIkU!5e0!3m2!1sen!2set!4v1620000000000!5m2!1sen!2set"
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <form action="submit_feedback.php" method="POST">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <textarea class="form-control" placeholder="Leave your message here" id="message" name="message" style="height: 150px" required></textarea>
